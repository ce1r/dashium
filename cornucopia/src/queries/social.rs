        ...
        UserQuery {
            ...
            extractor: |row: &tokio_postgres::Row| -> Result<UserBorrowed, tokio_postgres::Error> {
                Ok(UserBorrowed {
                    ...
                    hash: row.try_get(3)?,
                    salt: row.try_get(4)?,
                    is_activated: row.try_get(5)?,
                    mod_level: row.try_get(6)?,
                    udid: row.try_get(7)?,
                    stars: row.try_get(8)?,
                    demons: row.try_get(9)?,
                    creator_points: row.try_get(10)?,
                    diamonds: row.try_get(11)?,
                    moons: row.try_get(12)?,
                    secret_coins: row.try_get(13)?,
                    user_coins: row.try_get(14)?,
                    cube: row.try_get(15)?,
                    ship: row.try_get(16)?,
                    ball: row.try_get(17)?,
                    ufo: row.try_get(18)?,
                    wave: row.try_get(19)?,
                    robot: row.try_get(20)?,
                    spider: row.try_get(21)?,
                    swing: row.try_get(22)?,
                    jetpack: row.try_get(23)?,
                    glow: row.try_get(24)?,
                    explosion: row.try_get(25)?,
                    icon: row.try_get(26)?,
                    icon_type: row.try_get(27)?,
                    color1: row.try_get(28)?,
                    color2: row.try_get(29)?,
                    color3: row.try_get(30)?,
                    accept_friend_requests: row.try_get(31)?,
                    message_setting: row.try_get(32)?,
                    comment_setting: row.try_get(33)?,
                    youtube: row.try_get(34)?,
                    twitter: row.try_get(35)?,
                    twitch: row.try_get(36)?,
                    discord: row.try_get(37)?,
                    instagram: row.try_get(38)?,
                    tiktok: row.try_get(39)?,
                    created_at: row.try_get(40)?,
                })
            },
